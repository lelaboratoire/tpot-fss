...
# Average CV score on the training set was:0.7267927326659251
exported_pipeline = make_pipeline(
    DatasetSelector(sel_subset=0, subset_list="subsets.csv"),
    OneHotEncoder(minimum_fraction=0.05, sparse=False, threshold=10),
    GradientBoostingClassifier(learning_rate=0.1, max_depth=7, max_features=0.05, min_samples_leaf=3, min_samples_split=3, n_estimators=100, subsample=0.8500000000000001)
)
