...
exported_pipeline = make_pipeline(
    ...
    GradientBoostingClassifier(learning_rate=0.5, max_depth=4, max_features=0.45, min_samples_leaf=4, min_samples_split=12, n_estimators=100, subsample=0.8500000000000001)
)
