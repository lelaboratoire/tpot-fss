...
accu.real.ds <- read_csv(paste0("RNASeq/accuracyDF.csv")) %>% dplyr::filter(subidx == 4)
...
lapply(list(accu.sim.reg, accu.sim.ds, accu.real.reg, accu.real.ds), get_optimal_idx)
